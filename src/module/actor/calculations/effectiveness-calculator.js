...
export function GetMonEffectiveness(data) {
    ...
    let abilities = {
        ...
        "Levitate": {active: false, execute: function(typeCalc) {typeCalc["Ground"] *= 0.5; return typeCalc;}},
    ...
    // once, not twice. If both Abilities are there, only calculate one and leave the conditional Damage
