...
export default class ItemsComponent extends Component {
    ...
    async render() {
        ...
        if (this.state.actor.type == 'character') {
            ...
            dividerIcon = `<img class='divider-image' src='systems/${SystemPaths.systemId()}/assets/images/icons/DividerIcon_Items.png' style='border:none; width:200px;'>`
            ...
            if (items.length > 0) {
                ...
                for (const item of items.sort(this._sort)) {
                    output += await renderTemplate(`/systems/${SystemPaths.systemId()}/templates/sidebar/components/items-component.hbs`, {
                        name: item.name,
                        img: item.img,
                        id: item.id,
                        color: 'gray',
            ...
            dividerIcon = `<img class='divider-image' src='systems/${SystemPaths.systemId()}/assets/images/icons/DividerIcon_HeldItem.png' style='border:none; width:200px;'>`
