...
export async function GetItemArt(item_name, type = ".webp") { 
    ...
    const imgDirectoryPath = `systems/${SystemPaths.systemId()}/assets/images/item_icons/`;
...
//     if((item_current_img == "icons/svg/mystery-man.svg") || (item_current_img == "icons/svg/item-bag.svg") || (item_current_img == `systems/${SystemPaths.systemId()}/assets/images/item_icons/generic item.webp`))
//     {
//         let new_image = await GetItemArt(item_name);
        
//         // Default to item-bag icon instead of 'Old Gateau'
//         if(new_image === `systems/${SystemPaths.systemId()}/assets/images/item_icons/generic item.webp`)
