...
export async function RollCaptureChance(trainer, target, pokeball, to_hit_roll, target_token) 
{
	...
	function isStoneEvo(species) {
		...
		const STONE_EVO_MONS = [
			...
			"Seedot", "Shiftry", "Nidorina", "Nidorino", "Nidoran", "Nidoking", "Nidoqueen", "Nidoran - Male", "Nidoran - Female", "Clefairy", "Cleffa",
			...
			"Minccino", "Cinccino", "Floette", "Florges", "Flabebe", "Murkrow", "Honchkrow", "Misdreavus", "Mismagius", "Lampent", "Litwick",
			"Chandelure", "Doublade", "Honedge", "Aegislash", "Kirlia", "Ralts", "Gardevoir", "Gallade", "Snorunt", "Glalie", "Froslass",
			"Rockruff", "Lycanroc - Midday", "Lycanroc - Midnight", "Lycanroc - Dusk", "Cubone", "Alolan Marowak", "Alolan Sandshrew", "Alolan Sandslash",
			"Alolan Vulpix", "Alolan Ninetales", "Crabrawler", "Crabominable", "Galarian Darumaka", "Galarian Darmanitan", "Galarian Darmanitan - Zen Snowed",
			"Mime. Jr.", "Mr. Mime", "Mr. Rime", "Galarian Mr. Mime", "Koffing", "Galarian Weezing", "Alolan Raichu", "Magnemite", "Magneton", "Magnezone",
			"Nosepass", "Probopass", "Slowpoke", "Slowbro"
		];
	...
	const pokeball_stats = {
		...
		"Level Ball": { "Base Modifier": 0, "Conditions": "-20 Modifier if the target is under half the level your active Pokemon is.", "Conditional Modifier": -20 },
		...
		"Friend Ball": { "Base Modifier": -5, "Effects": "A caught Pokemon will start with +1 Loyalty." },
		"Love Ball": { "Base Modifier": 0, "Conditions": "-30 Modifier if the user has an active Pokemon that is of the same evolutionary line as the target, and the opposite gender. Does not work with genderless Pokemon.", "Conditional Modifier": -30 },
		...
		"Repeat Ball": { "Base Modifier": 0 , "Conditions": "-20 Modifier if the user already owns a Pokemon of the target's species.", "Conditional Modifier": -20 },
		...
		"Luxury Ball": { "Base Modifier": -5, "Effects": "A caught Pokemon is easily pleased and starts with a raised happiness." },
		"Heal Ball": { "Base Modifier": -5, "Effects": "A caught Pokemon will heal to Max HP immediately upon capture." },
