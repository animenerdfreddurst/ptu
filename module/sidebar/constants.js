...
export const Orders_Agility_Training_Mark_off = "<div title='Agility Orders: +1 bonus to Movement Capabilities and +4 to Initiative.' 									style='background-color: #333333; color:#cccccc; border-left:5px solid darkgray; 	width:100%; 					height:25px;font-size:20px;	font-family: FTY SKORZHEN NCV;	display: flex;	justify-content: center;align-items: center;'>Agility Orders</div>";
export const Orders_Brutal_Training_Mark_off = "<div title='Brutal Orders: Increase the Critical-Hit and Effect Range of all attacks by +1.' 							style='background-color: #333333; color:#cccccc; border-left:5px solid darkgray; 	width:100%; 					height:25px;font-size:20px;	font-family: FTY SKORZHEN NCV;	display: flex;	justify-content: center;align-items: center;'>Brutal Orders</div>";
export const Orders_Focused_Training_Mark_off = "<div title='Focused Orders: gain a +1 bonus to Accuracy Rolls and +2 to Skill Checks.' 								style='background-color: #333333; color:#cccccc; border-left:5px solid darkgray; 	width:100%; 					height:25px;font-size:20px;	font-family: FTY SKORZHEN NCV;	display: flex;	justify-content: center;align-items: center;'>Focused Orders</div>";
export const Orders_Inspired_Training_Mark_off = "<div title='Inspired Orders: +1 bonus to Evasion and +2 to Save Checks.' 												style='background-color: #333333; color:#cccccc; border-left:5px solid darkgray; 	width:100%; 					height:25px;font-size:20px;	font-family: FTY SKORZHEN NCV;	display: flex;	justify-content: center;align-items: center;'>Inspired Orders</div>";
export const Orders_Critical_Moment_Mark_off = "<div title='Critical Moment: The bonuses from your Pokemon’s [Training] are tripled until the end of your next turn.' 		style='background-color: #333333; color:#cccccc; border-left:5px solid darkgray; 	width:100%; 					height:25px;font-size:20px;	font-family: FTY SKORZHEN NCV;	display: flex;	justify-content: center;align-items: center;'>Critical Moment!</div>";

export const Orders_Agility_Training_Mark_on = "<div title='Agility Orders: +1 bonus to Movement Capabilities and +4 to Initiative.' 									style='background-color: #333333; color:#cccccc; border-left:5px solid green; 		width:100%; 					height:25px;font-size:20px;	font-family: FTY SKORZHEN NCV;	display: flex;	justify-content: center;align-items: center;'>Agility Orders</div>";
export const Orders_Brutal_Training_Mark_on = "<div title='Brutal Orders: Increase the Critical-Hit and Effect Range of all attacks by +1.' 								style='background-color: #333333; color:#cccccc; border-left:5px solid green; 		width:100%; 					height:25px;font-size:20px;	font-family: FTY SKORZHEN NCV;	display: flex;	justify-content: center;align-items: center;'>Brutal Orders</div>";
export const Orders_Focused_Training_Mark_on = "<div title='Focused Orders: gain a +1 bonus to Accuracy Rolls and +2 to Skill Checks.' 								style='background-color: #333333; color:#cccccc; border-left:5px solid green; 		width:100%; 					height:25px;font-size:20px;	font-family: FTY SKORZHEN NCV;	display: flex;	justify-content: center;align-items: center;'>Focused Orders</div>";
export const Orders_Inspired_Training_Mark_on = "<div title='Inspired Orders: +1 bonus to Evasion and +2 to Save Checks.' 												style='background-color: #333333; color:#cccccc; border-left:5px solid green; 		width:100%; 					height:25px;font-size:20px;	font-family: FTY SKORZHEN NCV;	display: flex;	justify-content: center;align-items: center;'>Inspired Orders</div>";
export const Orders_Critical_Moment_Mark_on = "<div title='Critical Moment: The bonuses from your Pokemon’s [Training] are tripled until the end of your next turn.' 		style='background-color: #333333; color:#cccccc; border-left:5px solid green; 		width:100%; 					height:25px;font-size:20px;	font-family: FTY SKORZHEN NCV;	display: flex;	justify-content: center;align-items: center;'>Critical Moment!</div>";
